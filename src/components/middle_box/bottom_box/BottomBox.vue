  ...
  <div class="bottom-box">
    <div class="progress-box" @click="setSongDot" ref="progressBox">
      ...
      <div
        class="slider-dot"
        :style="{
          'margin-left': (duration === null ? 0 : (currentTime / duration) * 744) + 'px',
        }"
    ...
    <div class="play-contral-box">
      ...
      <div class="palying-or-paused" @click="playContral">
        <img :src="isPlaying ? playingImgUrl : pausedImgUrl" width="40px" />
      </div>
  ...
  methods: {
    ...
    volumeDotMove(e) {
      if (this.isVolumeDotMovable) {
        ...
        let volume = Number((volumeDotX / 120).toFixed(2));
